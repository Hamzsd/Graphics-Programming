...
void initialise()
{
	...
	shaders[0] = loadShader("lighting.vert", GL_VERTEX_SHADER);
	shaders[1] = loadShader("lighting.frag", GL_FRAGMENT_SHADER);
	...
	//object.geometry = createSphere(50,50);
...
void render(const glm::mat4& view, const glm::mat4& projection, const render_object& object)
{
		...
		glUniform1f(shininessUniform, 5.0f);
